...
import { dicePlusAvailableKey, ID, metadataKey } from "../helper/variables.ts";
...
export const dicePlusResponseChannel = `${ID}/roll-result`;
// export const dicePlusResponseChannel = `dice-plus/roll-result`;
export const dicePlusErrorChannel = `${ID}/roll-error`;
